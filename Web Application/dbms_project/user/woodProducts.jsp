...
try
{
	PreparedStatement ps = conn.prepareStatement("SELECT DISTINCT PRODUCT_NAME FROM PRODUCT JOIN PRODUCTION USING (PRODUCT_ID,PRODUCT_DATE) JOIN COMPANY USING (COMPANY_TRADE_NUM) JOIN waste_recycling USING (COMPANY_TRADE_NUM) JOIN Recycling_Process USING (process_date,process_id)JOIN wood_recycling USING (process_id,process_date)");
