...
try
{
	PreparedStatement ps = conn.prepareStatement("SELECT machine_name, processing_type FROM machine JOIN used_tecnology USING (machine_no) JOIN Recycling_Process USING(process_id,process_date) JOIN tyre_recycling USING(process_id,process_date)");
